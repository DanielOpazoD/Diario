    ...
    <div className="sticky top-0 z-20 bg-gray-50/95 dark:bg-gray-950/95 backdrop-blur-md pt-1 pb-3 mb-2 -mx-4 px-4 md:mx-0 md:px-0">
      <div className="flex overflow-x-auto no-scrollbar pb-1 gap-2 items-center">
        <button
          ...
          className={`flex-shrink-0 flex items-center gap-2 px-3 py-2 rounded-pill text-xs font-bold uppercase tracking-wide transition-all border shadow-soft ${activeFilter === 'all' ? 'bg-gray-900 text-white border-gray-800 dark:bg-white dark:text-gray-900 scale-[1.02]' : 'bg-white/90 dark:bg-gray-800 text-gray-600 border-gray-200 dark:border-gray-700 hover:border-gray-300'}`}
        >
        ...
        {stats.map(stat => (
          <button
            ...
            className={`flex-shrink-0 flex items-center gap-2 px-3 py-2 rounded-pill text-xs font-bold uppercase tracking-wide transition-all border whitespace-nowrap shadow-soft ${
