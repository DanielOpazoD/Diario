...
var apiKey = process.env.GEMINI_API_KEY || process.env.VITE_GEMINI_API_KEY || process.env.VITE_API_KEY || "";
var genAI = apiKey && apiKey !== "your_gemini_key_here" ? new GoogleGenerativeAI(apiKey) : null;
var analysisSchema = {
...
var parseBody = (event) => {
  ...
  if (!payload.action) throw new Error("Acci\xF3n de Gemini no especificada.");
  return payload;
};
  ...
  try {
    ...
    switch (payload.action) {
          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: 'Extract Hanga Roa hospital data (Spanish). Be concise.\n- name: "Name Surname". Title Case.\n- rut: Full RUT.\n- birthDate: YYYY-MM-DD.\n- gender: Sex/Gender.\n- diagnosis: Use ONLY "HIPOTESIS DIAGN\xD3STICA". IGNORE "DIAGN\xD3STICO PRI". STOP strictly at "INDICACIONES M\xC9DICAS / PLAN DE TTO", "Comentario", or any other section.\n- clinicalNote: Content from "INDICACIONES M\xC9DICAS / PLAN DE TTO", "PLAN", "EVOLUCI\xD3N", or "Comentario". CRITICAL: DO NOT include the headers (like "INDICACIONES M\xC9DICAS / PLAN DE TTO:") in the value.'
                },
          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: 'Extrae datos de paciente desde texto cl\xEDnico (espa\xF1ol). Devuelve solo el JSON v\xE1lido.\n- name: "Nombre Apellido" en Title Case.\n- rut: RUT completo si est\xE1.\n- birthDate: YYYY-MM-DD.\n- gender: Masculino/Femenino/Otro.\n- diagnosis: SOLO "HIPOTESIS DIAGN\xD3STICA" si existe.\n- clinicalNote: "INDICACIONES M\xC9DICAS / PLAN DE TTO", "PLAN", "EVOLUCI\xD3N" o "Comentario" sin encabezados.'
                },
          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: 'Extract patient list (Spanish). Concise fields.\n- name: "Name Surname". Title Case.\n- rut: Full RUT.\n- birthDate: YYYY-MM-DD.\n- gender: Sex/Gender.\n- diagnosis: Use ONLY "HIPOTESIS DIAGN\xD3STICA". IGNORE "DIAGN\xD3STICO PRI". STOP at "INDICACIONES M\xC9DICAS" or "Plan".\n- clinicalNote: Content from "INDICACIONES M\xC9DICAS / PLAN DE TTO", "PLAN", or "EVOLUCI\xD3N". STRIP labels from the text.'
                },
                { inlineData: { data: payload.base64Image, mimeType: payload.mimeType } }
              ]
            }
      ...
      case "askAboutImages": {
        ...
        const imageParts = (payload.images || []).map((image) => {
        ...
        if (imageParts.length === 0) {
          throw new Error("No se recibieron archivos compatibles (im\xE1genes o PDF).");
        }
      ...
      case "extractLabResults": {
        ...
        const imagePart = payload.base64Image && payload.mimeType ? { inlineData: { data: payload.base64Image, mimeType: payload.mimeType } } : null;
        if (!textPart && !imagePart) {
          throw new Error("Se requiere texto o imagen para extraer resultados de laboratorio.");
        }
        const prompt = `Extrae los resultados de ex\xE1menes de laboratorio de forma notificativa y resumida en un p\xE1rrafo continuo (formato cl\xEDnico). 
Usa estrictamente las siguientes abreviaturas si los datos est\xE1n presentes:
Fecha examenes (dia-mes-a\xF1o): HTO Hg RGB %PMN Plaquetas Creat BUN Na K Cl HCO3 GOT GPT GGT FA BT BD Hbglic RAC
Colesterol total LDL TG HDL TSH T4L
Sedimento de orina: GR LEU Bacterias.

Explicaci\xF3n de abreviaturas para tu conocimiento:
HTO=hematocrito, Hg=hemoglobina, RGB=recuento de gl\xF3bulos blancos, %PMN=polimorfonucleares, Plaquetas, Creat=creatinina, BUN=nitr\xF3geno ureico, Na=sodio, K=potasio, Cl=cloro, HCO3=bicarbonato, GOT/GPT/GGT/FA=pruebas hep\xE1ticas, BT/BD=bilirrubina total/directa, Hbglic=hemoglobina glicosilada, RAC=relaci\xF3n alb\xFAmina/creatinina, TSH/T4L=perfil tiroideo.

Si alg\xFAn examen no est\xE1 en el documento, simplemente om\xEDtelo del p\xE1rrafo. No inventes datos. 
La respuesta debe ser SOLO el p\xE1rrafo con los resultados.`;
        const contents = [
          {
            role: "user",
            parts: [
      ...
      default:
        return { statusCode: 400, body: JSON.stringify({ error: "Acci\xF3n no soportada" }) };
    }
  } catch (error) {
